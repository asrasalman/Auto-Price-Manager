<%@ Page Title="" Language="C#" MasterPageFile="~/master/Main.master" AutoEventWireup="true" ValidateRequest="false"
    CodeFile="Admin-Email.aspx.cs" Inherits="pages_admin_Admin_Email" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class='emailContainer'>
        ...
        <h3>
            Email Body </h3>
        Subject: <asp:TextBox ID="txtSubject" runat="server" CssClass="txtSubject"></asp:TextBox>
        ...
        <asp:Button ID="btnSendEmail" runat="server" 
            OnClientClick="return CheckEmailSend()" CssClass="button3"
